...
# 
# # ------------------------------ROUTES-------------------------------------
# @app.route('/dashboard/<string:user_type>/<int:user_id>', methods=['GET', 'POST'])
# @login_required
# def dashboard(user_id, user_type):
#     if user_type == 'Student':  # getting it from radio button
#         logged_user = student_login.query.get(user_id)
#     elif user_type == 'Teacher':
#         logged_user = teacher_login.query.get(user_id)
#
#     if logged_user:
#         # Flash the email attribute
...
#         user = students(FIRST_NAME=form.first_name.data, LAST_NAME=form.last_name.data, DEPARTMENT=form.department.data,
...
#
#     if form.validate_on_submit():
#         user = teachers(FIRST_NAME=form.first_name.data, LAST_NAME=form.last_name.data, DEPARTMENT=form.department.data,
#                         PHONE_NUMBER=form.phone_number.data)
#         if user:
#             db.session.add(user)
#             db.session.commit()
